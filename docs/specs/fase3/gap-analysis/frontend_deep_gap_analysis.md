...
> **Diretrizes de Referência:** [`.agents/AGENTS.md`](file:///home/josemd12/Code/AutoReparos/.agents/AGENTS.md) & [`.agents/skills/angular-component/SKILL.md`](file:///home/josemd12/Code/AutoReparos/.agents/skills/angular-component/SKILL.md)  
...
Abaixo estão listadas as divergências entre o que os serviços Angular em [`AutoReparos.Web`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/core/config/api-endpoints.ts) disparam e o que os endpoints do ASP.NET Core em [`AutoReparos.API`](file:///home/josemd12/Code/AutoReparos/AutoReparos.API/Endpoints/OrdemServicoEndpoint.cs) esperam:

| Funcionalidade / Tela | Chamada no Frontend (`AutoReparos.Web`) | Implementação Real no Backend (`AutoReparos.API`) | Status em Runtime |
| :--- | :--- | :--- | :---: |
| **Abertura de Nova OS**<br>([`OsNovaPageComponent`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/pages/os-nova-page/os-nova-page.component.ts#L370-L374)) | Envia `{ clienteId, veiculoId, observacoesIniciais }` via `POST /api/ordem-servico` | `CriarOrdemServicoDto` exige obrigatoriamente `DocumentoCliente` e `PlacaVeiculo`. | ❌ **400 Bad Request**<br>(Falha de validação) |
| **Adicionar Serviço na OS**<br>([`OsDetalhePageComponent`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/pages/os-detalhe-page/os-detalhe-page.component.ts#L349)) | Envia `{ servicoId }` | `AdicionarServicoDto` exige obrigatoriamente `ValorCobrado > 0`. | ❌ **400 Bad Request**<br>(ValorCobrado ausente) |
| **Adicionar Insumo na OS**<br>([`OsDetalhePageComponent`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/pages/os-detalhe-page/os-detalhe-page.component.ts#L360)) | Envia `{ insumoId, quantidade }` | `AdicionarInsumoDto` exige obrigatoriamente `Descricao` e `Origem` (Estoque ou Compra). | ❌ **400 Bad Request**<br>(Campos obrigatórios faltando) |
| **Consulta Pública de OS**<br>([`ConsultaPublicaPageComponent`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/portal-publico/pages/consulta-publica-page/consulta-publica-page.component.ts#L236)) | Envia query param `?termo=ABC1234` | Backend espera `?documento=...` ou `?placa=...` (`OrdemServicoConsultaPagedRequest`). | ❌ **Retorna lista vazia**<br>(Ignora o termo) |
| **Aprovar/Recusar via Token**<br>([`AprovacaoOrcamentoPageComponent`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/portal-publico/pages/aprovacao-orcamento-page/aprovacao-orcamento-page.component.ts#L149)) | Envia `POST /api/ordem-servico/aprovar` com `{ token, aprovado }` | Backend implementa `GET /api/ordem-servico/aprovar?token=...` e `GET /recusar?token=...`. | ❌ **405 Method Not Allowed** |
| **Enviar para Aprovação**<br>([`ordem-servico.service.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/services/ordem-servico.service.ts#L89)) | Envia `POST /{id}/enviar-para-aprovacao` | Backend mapeia com `group.MapPatch("/{id}/enviar-para-aprovacao")`. | ❌ **405 Method Not Allowed** |
| **Iniciar Diagnóstico**<br>([`ordem-servico.service.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/services/ordem-servico.service.ts#L73)) | Envia `PUT /{id}/iniciar-diagnostico` com body `{ observacoes }` | Backend mapeia com `PATCH /{id}/iniciar-diagnostico` sem body. | ❌ **405 Method Not Allowed** |
| **Entregar Veículo**<br>([`ordem-servico.service.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/services/ordem-servico.service.ts#L97)) | Envia `POST /{id}/entregar` | Backend mapeia com `PATCH /{id}/entregar`. | ❌ **405 Method Not Allowed** |
| **Concluir Serviço da OS**<br>([`ordem-servico.service.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/services/ordem-servico.service.ts#L85)) | Envia `PUT /{osId}/servicos/{itemId}/concluir` | Backend mapeia com `PATCH /{osId}/servicos/{itemId}/concluir` sem body. | ❌ **405 Method Not Allowed** |
| **Alterar Status Genérico da OS**<br>([`ordem-servico.service.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/services/ordem-servico.service.ts#L69)) | Envia `PATCH /api/ordem-servico/{id}/status` com `{ novoStatus }` | **Não existe essa rota no backend.** Transições de status são por ações explícitas. | ❌ **404 Not Found** |
| **Atualizar Perfil de Usuário**<br>([`usuario.service.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/usuarios/services/usuario.service.ts#L42)) | Envia `PATCH /api/usuarios/{id}/role` com `{ role }` | **Não existe essa rota no backend.** Backend mapeia `PUT /api/usuarios/{id}` com `UsuarioUpdateDto`. | ❌ **404 Not Found** |
...
* **[`os-kanban-page.component.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/pages/os-kanban-page/os-kanban-page.component.ts):**
...
* **[`os-nova-page.component.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/pages/os-nova-page/os-nova-page.component.ts):**
...
* **[`os-detalhe-page.component.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/ordens-servico/pages/os-detalhe-page/os-detalhe-page.component.ts):**
...
* **[`consulta-publica-page.component.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/portal-publico/pages/consulta-publica-page/consulta-publica-page.component.ts):**
...
* **[`aprovacao-orcamento-page.component.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/portal-publico/pages/aprovacao-orcamento-page/aprovacao-orcamento-page.component.ts):**
...
* **[`clientes-page.component.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/clientes/pages/clientes-page/clientes-page.component.ts):**
...
* **[`dashboard-page.component.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/dashboard/pages/dashboard-page/dashboard-page.component.ts):**
...
* **Diagnóstico de Cobertura:**
  * O único arquivo de teste é [`src/app/app.spec.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/app.spec.ts), que apenas instancia o `AppComponent` raiz e verifica se o título é renderizado.
...
1. Atualizar [`cliente.model.ts`](file:///home/josemd12/Code/AutoReparos/AutoReparos.Web/src/app/features/clientes/models/cliente.model.ts) com o campo `status: 'Ativo' | 'Inativo' | 'Bloqueado'`.
