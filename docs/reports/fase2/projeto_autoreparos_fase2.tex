...
\begin{tcolorbox}[elegantbox]
    \begin{minipage}[t]{0.52\textwidth}
        \textbf{\color{primary}\faIcon{link} Links do Projeto}
        \vspace{0.2cm}
        \begin{itemize}
    ...
    \begin{minipage}[t]{0.42\textwidth}
        \textbf{\color{primary}\faIcon{users} Integrantes do Grupo 78}
        \vspace{0.2cm}
        \begin{itemize}
...
% --- ARQUITETURA CLOUD ---
\begin{center}
    \textbf{\large \color{primary}\faIcon{cloud} Desenho da Arquitetura Cloud (AWS \& Kubernetes)}
\end{center}
\vspace{0.1cm}
\begin{center}
...
\begin{tcolorbox}[colback=white, colframe=borderlight, boxrule=0.5pt, arc=4pt, left=8pt, right=8pt, top=6pt, bottom=6pt]
    \small
    \textbf{\color{primary}\faIcon{tools} Visão Geral e Principais Componentes Implementados na Fase 2:}
    \vspace{0.15cm}
    \begin{itemize}
