...
helm dependency update submodules/AutoReparos.Infra.K8s/k8s/
...
helm upgrade --install autoreparos submodules/AutoReparos.Infra.K8s/k8s/ \
  -f submodules/AutoReparos.Infra.K8s/k8s/values.yaml \
